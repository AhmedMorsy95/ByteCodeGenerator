...
union YYSTYPE
{
#line 6 "parse.y" /* yacc.c:355  */

	int ival;
	float fval;
  char name[20];

#line 125 "parse.tab.c" /* yacc.c:355  */
};
...
{
  "$end", "error", "$undefined", "INT", "FLOAT", "ID", "ADDOP", "MULOP",
  "SEMICOLON", "$accept", "method_body", "statement_list", "statement",
  "declaration", "primitive_type", YY_NULLPTR
};
#endif
...
#line 1224 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 28 "parse.y" /* yacc.c:1646  */
    {printf("type %s",(yyval.name));}
#line 1230 "parse.tab.c" /* yacc.c:1646  */
    break;
